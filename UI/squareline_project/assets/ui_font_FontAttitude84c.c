...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 887, .box_w = 45, .box_h = 44, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 990, .adv_w = 448, .box_w = 22, .box_h = 14, .ofs_x = 3, .ofs_y = 16},
    {.bitmap_index = 1144, .adv_w = 896, .box_w = 50, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 2644, .adv_w = 896, .box_w = 45, .box_h = 58, .ofs_x = 8, .ofs_y = 0},
    {.bitmap_index = 3949, .adv_w = 896, .box_w = 48, .box_h = 58, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5341, .adv_w = 896, .box_w = 50, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 6841, .adv_w = 896, .box_w = 54, .box_h = 59, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 8434, .adv_w = 896, .box_w = 50, .box_h = 59, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 9909, .adv_w = 896, .box_w = 50, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 11409, .adv_w = 896, .box_w = 50, .box_h = 58, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 12859, .adv_w = 896, .box_w = 50, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 14359, .adv_w = 896, .box_w = 50, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 15859, .adv_w = 538, .box_w = 26, .box_h = 25, .ofs_x = 4, .ofs_y = 33}
};
