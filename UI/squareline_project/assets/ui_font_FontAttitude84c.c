 ...
 * Size: 84 px
 * Bpp: 4
 * Opts: --bpp 4 --size 84 --font /Users/matti.vesalasofigate.com/Documents/Arduino/ESP32-Crowpanel-compass/UI/squareline_project/assets/ArchivoBlack-Regular.ttf -o /Users/matti.vesalasofigate.com/Documents/Arduino/ESP32-Crowpanel-compass/UI/squareline_project/assets/ui_font_FontAttitude84c.c --format lvgl --symbols 01234567890+-°% --no-compress --no-prefilter
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3300, .adv_w = 448, .box_w = 22, .box_h = 14, .ofs_x = 3, .ofs_y = 16},
    {.bitmap_index = 3454, .adv_w = 896, .box_w = 50, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 4954, .adv_w = 896, .box_w = 45, .box_h = 58, .ofs_x = 8, .ofs_y = 0},
    {.bitmap_index = 6259, .adv_w = 896, .box_w = 48, .box_h = 58, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 7651, .adv_w = 896, .box_w = 50, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 9151, .adv_w = 896, .box_w = 54, .box_h = 59, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 10744, .adv_w = 896, .box_w = 50, .box_h = 59, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 12219, .adv_w = 896, .box_w = 50, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 13719, .adv_w = 896, .box_w = 50, .box_h = 58, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 15169, .adv_w = 896, .box_w = 50, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 16669, .adv_w = 896, .box_w = 50, .box_h = 60, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 18169, .adv_w = 538, .box_w = 26, .box_h = 25, .ofs_x = 4, .ofs_y = 33}
};
