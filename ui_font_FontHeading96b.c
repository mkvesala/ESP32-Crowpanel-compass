 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --bpp 4 --size 96 --font /Users/matti.vesalasofigate.com/Documents/Arduino/ESP32-Crowpanel-compass/UI/assets/ArchivoBlack-Regular.ttf -o /Users/matti.vesalasofigate.com/Documents/Arduino/ESP32-Crowpanel-compass/UI/assets/ui_font_FontHeading96b.c --format lvgl --symbols 1234567890-° --no-compress --no-prefilter
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 511, .box_w = 26, .box_h = 16, .ofs_x = 3, .ofs_y = 19},
    {.bitmap_index = 208, .adv_w = 1025, .box_w = 58, .box_h = 69, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 2209, .adv_w = 1025, .box_w = 50, .box_h = 67, .ofs_x = 10, .ofs_y = 0},
    {.bitmap_index = 3884, .adv_w = 1025, .box_w = 56, .box_h = 68, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5788, .adv_w = 1025, .box_w = 56, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 7720, .adv_w = 1025, .box_w = 60, .box_h = 68, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 9760, .adv_w = 1025, .box_w = 57, .box_h = 68, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 11698, .adv_w = 1025, .box_w = 58, .box_h = 69, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 13699, .adv_w = 1025, .box_w = 56, .box_h = 67, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 15575, .adv_w = 1025, .box_w = 58, .box_h = 69, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 17576, .adv_w = 1025, .box_w = 58, .box_h = 69, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 19577, .adv_w = 614, .box_w = 30, .box_h = 29, .ofs_x = 4, .ofs_y = 39}
};
